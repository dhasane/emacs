...
(general-define-key
 ...
 "C-S-s" 'dh/save-all-buffers
 "C-/"   'dh/comment-or-uncomment-line-or-region
 )
...
(general-define-key
 ...
 "e" '(find-file   :wk "File in Directory")
 "E" '(dh/jet-pack :wk "File in Proyect")
 ...
 "'r" 'dh/reload-emacs-config
 "'e" 'dh/open-emacs-config
 "'s" 'proced
